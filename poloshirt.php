                ...
                <div class="welcome-img-box">
                    <div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-one" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox" style="height: 70vh;">
                            <div class="item active slide-1" style="background-image: url(img/polo/Cotton\ Polo\ shirt.png);background-position: top;background-size:contain;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                                                <div class="content ">
                                                <h3 data-animation="animated fadeInDown" style="color:black;">Cotton </h3>
                            ...
                            <div class="item active slide-2" style="background-image: url(img/polo/nylon\ Polo\ shirt.png);background-position: top; background-size:contain;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                                                <div class="content ">
                                                    <h3 data-animation="animated fadeInDown" style="color:black;">Nylon </h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item slide-3" style="background-image: url(img/polo/Polyester\ Polo\ shirt.png);background-position: top; background-size:contain;">

                                <div class="carousel-caption">
                                    <div class="thm-container">
                                        <div class="box valign-middle">
                                            <div class="content ">
                                            <h3 data-animation="animated fadeInDown" style="color:black;">Polyester</h3>
