                ...
                <div class="welcome-img-box">
                    <div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-one" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox" style="height: 70vh;">
                            <div class="item active slide-1" style="background-image: url(img/tshirts/Cotton\ T\ shirt.png);background-position: top;background-size:contain;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                                                <div class="content ">
                                                <h3 data-animation="animated fadeInDown" style="color:white;">Cotton </h3>
                            ...
                            <div class="item active slide-2" style="background-image: url(img/tshirts/nylon\ T\ shirt.png);background-position: top;background-size:contain;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                                                <div class="content ">
                                                    <h3 data-animation="animated fadeInDown" style="color:white;">Nylon </h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item slide-3" style="background-image: url(img/tshirts/Polyester\ T\ shirt.png);background-position: top;background-size:contain;">

                                <div class="carousel-caption">
                                    <div class="thm-container">
                                        <div class="box valign-middle">
                                            <div class="content ">
                                            <h3 data-animation="animated fadeInDown" style="color:white;">Polyester</h3>
                            ...
                            <div class="item slide-4" style="background-image: url(img/tshirts/Sweatshirt.png);background-position: top;background-size:contain;">

                                <div class="carousel-caption">
                                    <div class="thm-container">
                                        <div class="box valign-middle">
                                            <div class="content ">
                                            <h3 data-animation="animated fadeInDown" style="color:white;">Sweat Shirt</h3>
