                ...
                <div class="welcome-img-box">
                    <div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-one" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox" style="height: 70vh;">
                            <div class="item active slide-1" style="background-image: url(img/pens/Metalic\ Pen.png);background-position: top ;background-size: contain; background-repeat: no-repeat;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                                                <div class="content ">
                                                <h3 data-animation="animated fadeInDown" style="color:black;">Metallic </h3>
                            ...
                            <div class="item active slide-2" style="background-image: url(img/pens/Plastic\ Pen.png);background-position: top;background-size: contain; background-repeat: no-repeat;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                                                <div class="content ">
                                                    <h3 data-animation="animated fadeInDown" style="color:black;">Plastic </h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item slide-3" style="background-image: url(img/pens/Wooden\ Pen.png);background-position: top;  background-size: contain; background-repeat: no-repeat; ">
