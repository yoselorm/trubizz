                ...
                <div class="welcome-img-box">
                    <div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-one" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox" style="height: 70vh;">
                            <div class="item active slide-1" style="background-image: url(img/diaries/Leather\ Diary.png);background-position: top ;background-size: contain; background-repeat: no-repeat;">
                                <div class="container">
                            ...
                            <div class="item active slide-2" style="background-image: url(img/diaries/Leather\ Diary.png);background-position: top;background-size: contain; background-repeat: no-repeat;">
                                <div class="container">
                                    <div class="carousel-caption">
                                        <div class="thm-container">
                                            <div class="box valign-middle">
                            ...
                            <div class="item slide-3" style="background-image: url(img/diaries/Wooden\ Diary.png);background-position: top;  background-size: contain; background-repeat: no-repeat; ">
